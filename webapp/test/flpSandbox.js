		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mmmaterialmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmmaterialmanagement-display": {
								"semanticObject": "mmmaterialmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.materialmanagement",
									"url": sap.ui.require.toUrl("mm/materialmanagement")
								}
							}
						}
					}
